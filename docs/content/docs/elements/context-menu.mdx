...
- `.elements-context-menu` - The menu container
- `.elements-context-menu.open` - Applied when menu is open
- `.elements-context-menu-backdrop` - Invisible backdrop for click-outside detection

ContextMenu extends [Group](/docs/elements/group) which extends [BaseElement](/docs/elements/base-element).
