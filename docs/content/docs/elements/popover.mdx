...
A generic floating element that renders in a portal overlay with backdrop dismiss, positioning, and open/close state management. Used as a base for context menus, tooltips, dropdowns, and other floating content.
