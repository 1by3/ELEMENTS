...
## Install ELEMENTS with UPM

You can install ELEMENTS using the Unity Package Manager (UPM).

- Instructions for UPM here
...
Note that we used the `OnEnable` method. This is an important detail that allows your UI to update when Unity reloads your game if you make code changes. If your UI is disappearing on reload, this might be why.
