...
Install NuGet using [NuGetForUnity](https://github.com/GlitchEnzo/NuGetForUnity) and then use it to install [R3](https://github.com/Cysharp/R3).
...
- We also loaded the ELEMENTS extended styles, which is a nice clean starting point until you add your own styles.
